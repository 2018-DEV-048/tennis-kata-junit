...
public class GameOfTennisTest extends TestCase {
	GameOfTennis game = new GameOfTennis("Roger Federer" , "Rafel Nadal");
	...
	public void testPlayerTwoWinsGame(){
		createScore(1,4);
		String score = game.getScore();
		assertEquals("Rafel Nadal wins", score);
	}
	...
	public void testPlayerTwoAdvantage(){
		createScore(4, 5);
		String score = game.getScore();
		assertEquals("Advantage Rafel Nadal", score);
	}
